    ...
    <Layout>
      <div className="container">
        <div className="col-md-6">
          ...
          <form action="{{url('heros/save-hero')}}" method="POST" className="my-5" onSubmit={createUser}>
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="health" placeholder="Health" onChange={(e) => setHealth(e.target.value)} />
            </div>
