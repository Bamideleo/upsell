...
function Edit(props) {
  ...
  var updateUser = function updateUser(event) {
    ...
    setLoading(true);
    _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__["Inertia"].patch("/heros/".concat(props.hero.id), {
      name: name,
      health: health
    }).then(function () {
      setLoading(false);
  ...
  var deleteUser = function deleteUser(event) {
    ...
    if (confirm('Are you sure you want to delete this contact?')) {
      _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__["Inertia"]["delete"]("/heros/".concat(props.hero.id)).then(function () {});
    }
  };
