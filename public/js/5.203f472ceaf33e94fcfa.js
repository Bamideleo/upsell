...
function Edit(props) {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(props.hero.name),
      _useState2 = _slicedToArray(_useState, 2),
      name = _useState2[0],
      setName = _useState2[1];

  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(props.hero.health),
  ...
  var updateUser = function updateUser(event) {
    ...
    setLoading(true);
    _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__["Inertia"].patch("/users/".concat(props.hero.id), {
      name: name,
      health: health
    }).then(function () {
      setLoading(false);
  ...
  var deleteUser = function deleteUser(event) {
    ...
    if (confirm('Are you sure you want to delete this contact?')) {
      _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__["Inertia"]["delete"]("/users/".concat(props.hero.id)).then(function () {});
    }
  };
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Shared_Layout__WEBPACK_IMPORTED_MODULE_2__["default"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    htmlFor: "email"
  }, "Health"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    type: "text",
    className: "form-control",
    id: "health",
    placeholder: "health",
    defaultValue: props.hero.healht,
    onChange: function onChange(e) {
      return setHealht(e.target.value);
    }
    ...
    color: '#fff',
    className: "mr-2"
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Update Hero")))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
