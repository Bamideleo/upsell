...
function Create(props) {
  ...
  var createUser = function createUser(event) {
    ...
    _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_2__["Inertia"].post('/users', {
      name: name,
      health: health
    }).then(function () {// code
    });
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Shared_Layout__WEBPACK_IMPORTED_MODULE_1__["default"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    action: "{{url('heros/save-hero')}}",
    method: "POST",
    className: "my-5",
    onSubmit: createUser
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "what"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
