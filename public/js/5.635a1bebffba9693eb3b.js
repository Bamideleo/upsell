...
function Edit(props) {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(props.hero.email),
      _useState4 = _slicedToArray(_useState3, 2),
      email = _useState4[0],
      setEmail = _useState4[1];

  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(props.hero.password),
  ...
  var updateUser = function updateUser(event) {
    ...
    setLoading(true);
    _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__["Inertia"].patch("/users/".concat(props.user.id), {
      name: name,
      email: email
    }).then(function () {
      setLoading(false);
  ...
  var deleteUser = function deleteUser(event) {
    ...
    if (confirm('Are you sure you want to delete this contact?')) {
      _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__["Inertia"]["delete"]("/users/".concat(props.user.id)).then(function () {});
    }
  };
